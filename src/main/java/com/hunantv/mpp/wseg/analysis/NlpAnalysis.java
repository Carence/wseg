...
import com.hunantv.mpp.wseg.dict.LearnTool;
...
import com.hunantv.mpp.wseg.recognition.NewWord;
...
import com.hunantv.mpp.wseg.segment.NewWordRecognition;
import com.hunantv.mpp.wseg.segment.Term;
import com.hunantv.mpp.wseg.segment.TermNatures;
import com.hunantv.mpp.wseg.segment.TermUtil;
			...
			public List<Term> merger() {
				...
				if (DEFAULT_SLITWORD != null) {
					...
					for (String word : words) {
						...
						MyItem item = DATDictionary.getItem(word);
						Term term = null;
						if (item != MyItem.NULL) {
