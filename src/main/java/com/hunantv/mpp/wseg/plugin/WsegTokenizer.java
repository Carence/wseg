...
import com.hunantv.mpp.wseg.analysis.Analysis;
...
public class WsegTokenizer extends Tokenizer {
	// 当前词
	...
	public WsegTokenizer(Analysis ta, Reader input, Set<String> filter, boolean pstemming) {
		super(input);
		this.ta = ta;
		this.filter = filter;
	...
	public void reset() throws IOException {
		super.reset();
		ta.resetContent(new MyReader(this.input));
	}
